...
/*   Updated: 2025/02/14 16:18:05 by ele-borg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	dup_close_read_pipe(int k, t_element *elements, t_cmd *cmd, t_gc *gc)
{
...
void	dup_close_write_pipe(int k, t_element *elements, t_cmd *cmd, t_gc *gc)
{
